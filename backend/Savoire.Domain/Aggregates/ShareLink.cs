...
public sealed class ShareLink
{
    ...
    public string    Permission   { get; private set; } = null!;  // "read" | "write"
    ...
    public static ShareLink Create(
        ...
        string permission, string createdBy,
    ...
    public static ShareLink Rehydrate(
        string id, string token, string resourceType, string resourceId,
        string permission, string createdBy, DateTime createdAt,
        DateTime? expiresAt, DateTime? revokedAt) => new()
    {
        Id = id, Token = token, ResourceType = resourceType, ResourceId = resourceId,
        Permission = permission, CreatedBy = createdBy, CreatedAt = createdAt,
